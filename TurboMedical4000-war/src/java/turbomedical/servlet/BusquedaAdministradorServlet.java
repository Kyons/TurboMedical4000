 ...
 * @author jorge
 */
@WebServlet(name = "BusquedaAdministradorServlet", urlPatterns = {"/BusquedaAdministradorServlet"})
public class BusquedaAdministradorServlet extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        admins = administradorFacade.filtrarAdministrador(request.getParameter("usuario"));
        
        request.setAttribute("lista", admins);
