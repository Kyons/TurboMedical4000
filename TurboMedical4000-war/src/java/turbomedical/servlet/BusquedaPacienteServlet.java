 ...
 * @author jorge
 */
@WebServlet(name = "BusquedaPacienteServlet", urlPatterns = {"/BusquedaPacienteServlet"})
public class BusquedaPacienteServlet extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            pacientes = pacienteFacade.filtrarPacientes(request.getParameter("numSS"), 
            ...
            rd = this.getServletContext().getRequestDispatcher("/pacienteList.jsp");
