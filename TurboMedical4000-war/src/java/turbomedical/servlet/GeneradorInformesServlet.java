 ...
 * @author Juan
 */
@WebServlet(name = "GeneradorInformesServlet", urlPatterns = {"/GeneradorInformesServlet"})
public class GeneradorInformesServlet extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        rd = this.getServletContext().getRequestDispatcher("/generadorInformes.jsp");
